 ...
 *
 * $Revision: 42 $
 * $Id: Structure.java 42 2009-03-26 19:59:08Z gnovelli $
 * $HeadURL: https://josser.svn.sourceforge.net/svnroot/josser/branches/ui/project/src/net/sf/josser/rdf/impl/Structure.java $
 *
 *****************************************************************************************
 */
...
public class Structure extends Parser {
	...
	@Override
	public int stmtClear() {
		int result = 0;
		result += this.getAliasRow().stmtClear();
		result += this.getAltlangRow().stmtClear();
		result += this.getCategoryRow().stmtClear();
		result += this.getEditorRow().stmtClear();
		result += this.getLetterbarRow().stmtClear();
		result += this.getNarrowRow().stmtClear();
		result += this.getNewsGroupRow().stmtClear();
		result += this.getRelatedRow().stmtClear();
		result += this.getSymbolicRow().stmtClear();
		return result;
	}
