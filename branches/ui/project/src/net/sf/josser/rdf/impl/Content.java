 ...
 *
 * $Revision: 42 $
 * $Id: Content.java 42 2009-03-26 19:59:08Z gnovelli $
 * $HeadURL: https://josser.svn.sourceforge.net/svnroot/josser/branches/ui/project/src/net/sf/josser/rdf/impl/Content.java $
 *
 *****************************************************************************************
 */
...
public class Content extends Structure {
	...
	public int stmtClear() {
		return this.getExternalPageRow().stmtClear();
	}
